...
class RepoObservation(Base):
    ...
    observed_github_url: Mapped[str | None] = mapped_column(String(1024), nullable=True)
...
class PaperRepoState(Base):
    ...
    primary_github_url: Mapped[str | None] = mapped_column(String(255), nullable=True)
    github_urls_json: Mapped[list[str]] = mapped_column(JSON, default=list)
...
class GitHubRepo(Base):
    ...
    github_url: Mapped[str] = mapped_column(String(255), primary_key=True)
    ...
    name_with_owner: Mapped[str | None] = mapped_column(String(255), nullable=True)
    description: Mapped[str | None] = mapped_column(Text, nullable=True)
    homepage: Mapped[str | None] = mapped_column(String(1024), nullable=True)
    stargazers_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    forks_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    license_spdx_id: Mapped[str | None] = mapped_column(String(255), nullable=True)
    ...
    has_projects: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    has_wiki: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
