...
from src.ghstarsv2.debug_arxiv_listing import BASELINE_FIELDNAMES, compare_listing_baseline_against_db, generate_listing_baseline
from src.ghstarsv2.db import session_scope
from src.ghstarsv2.models import ArxivArchiveAppearance, Paper, utc_now
...
async def test_generate_listing_baseline_paginates_and_writes_month_csv(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("src.ghstarsv2.debug_arxiv_listing.ArxivMetadataClient", FakeClient)
